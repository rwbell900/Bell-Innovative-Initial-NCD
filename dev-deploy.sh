...
echo
near dev-deploy ./res/rs_ncddemo.wasm
...
echo "near call \$CONTRACT set_entity_name '{\"name\":\"Alices Wholesale Garden Products\"}' --accountId \$OWNER"
echo "near call \$CONTRACT set_entity_status '{\"status\":\"Applicant\"}' --accountId \$OWNER"
echo "near call \$CONTRACT set_entity_description '{\"description\":\"We supply the best all natural garden products\"}' --accountId \$OWNER"
echo "near call \$CONTRACT set_entity_status '{\"status\":\"Applicant\"}' --accountId \$OWNER"
